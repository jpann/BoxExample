...
namespace Camera
{
    public class Camera2D
    {
        ...
        public Camera2D(GraphicsDevice graphics)
        {
            ...
            //
            // Camera draws the DebugXNAView correctly if we use this projection
            _projection = Matrix.CreateOrthographicOffCenter(0,
                ConvertUnits.ToSimUnits(_graphics.Viewport.Width),
                ConvertUnits.ToSimUnits(_graphics.Viewport.Height),
                0,
                0,
                1);
